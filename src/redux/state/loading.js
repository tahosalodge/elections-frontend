...
export default combineReducers({
  election: makeMultiActionReducer(
    [ELECTION_FETCH_REQUEST, ELECTION_CREATE_REQUEST],
    [ELECTION_FETCH_SUCCESS, ELECTION_CREATE_SUCCESS],
    [ELECTION_FETCH_FAILURE, ELECTION_CREATE_FAILURE],
  ),
  user: makeReducer(USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_LOGIN_FAILURE),
  unit: makeMultiActionReducer(
    [UNIT_FETCH_REQUEST, UNIT_UPDATE_REQUEST, UNIT_GET_REQUEST],
    [UNIT_FETCH_SUCCESS, UNIT_UPDATE_SUCCESS, UNIT_GET_SUCCESS],
    [UNIT_FETCH_FAILURE, UNIT_UPDATE_FAILURE, UNIT_GET_FAILURE],
  ),
